...
@RestController
@Slf4j
@Component("ReversalPrepaidSmartfren")
public class Reversal {
    ...
    @RequestMapping(value = "/v1.0/reversal/smartfren-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
