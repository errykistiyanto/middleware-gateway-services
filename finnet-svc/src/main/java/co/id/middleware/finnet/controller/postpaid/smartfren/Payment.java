...
@RestController
@Slf4j
@Component("PaymentPostpaidSmartfren")
public class Payment {
    ...
    @RequestMapping(value = "/v1.0/payment/smartfren-postpaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
...
//        String fee = env.getProperty("finnet.smartfren.fee");
...
//        String feeAccount = env.getProperty("finnet.ss.feeAccount");
        String validationProductCode = env.getProperty("finnet.smartfren.productCode");
