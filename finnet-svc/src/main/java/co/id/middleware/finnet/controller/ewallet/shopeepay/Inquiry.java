...
public class Inquiry {
    ...
    @RequestMapping(value = "/v1.0/inquiry/shopeepay", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
    public ResponseEntity<String> Multibiller(@Valid @RequestBody InquiryRequest inquiryRequest,
        ...
        try {
            ...
            screen.append(receiptTransaction.receiptHeader("Top Up Shopeepay"));
            ...
            if (! channelCode.equals("6015")){ //!channelCode Open API
                ...
                screen.append(receiptTransaction.receiptInfo("Total", "IDR " + df.format(Long.valueOf(amount) + Long.valueOf(fee)).replace(",", ".") + ",00"));
            }
