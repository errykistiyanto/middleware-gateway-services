...
@RestController
@Slf4j
@Component("InquiryPrepaidXLPaketData")
public class Inquiry {
    ...
    @RequestMapping(value = "/v1.0/inquiry/xl_paketdata-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
    public ResponseEntity<String> Multibiller(@Valid @RequestBody InquiryRequest inquiryRequest,
        ...
        try {
            ...
            switch (Integer.parseInt(amount)) {
                ...
                case 249000:
                    screen.append(receiptTransaction.receiptHeader("XL Prepaid Paket Data"));
...
//                    screen.append("XL Prepaid Paket Data");
//                    screen.append("|");
//                    screen.append("|");
//                    screen.append("Nomor Handphone      : "+"0"+Long.valueOf(accountNumber).toString());
//                    screen.append("|");
//                    screen.append("Harga              : IDR "+df.format(Long.valueOf(amount)).replace(",", ".") + ",00");
//                    screen.append("|");
