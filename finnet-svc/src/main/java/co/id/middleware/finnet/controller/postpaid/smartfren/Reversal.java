...
@RestController
@Slf4j
@Component("ReversalPostpaidSmartfren")
public class Reversal {
    ...
    @RequestMapping(value = "/v1.0/reversal/smartfren-postpaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
