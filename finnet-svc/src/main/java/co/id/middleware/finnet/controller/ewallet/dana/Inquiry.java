...
public class Inquiry {
    ...
    @RequestMapping(value = "/v1.0/inquiry/dana", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
            ...
            if (resp != null) {
                ...
                switch (resp.getString(39)) {
                    ...
                    case "00":
                        ...
                        screen.append(receiptTransaction.receiptHeader("Top Up Dana"));
