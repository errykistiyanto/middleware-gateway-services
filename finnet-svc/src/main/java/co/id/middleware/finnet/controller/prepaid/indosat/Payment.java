...
@RestController
@Slf4j
@Component("PaymentPrepaidIndosat")
public class Payment {
    ...
    @RequestMapping(value = "/v1.0/payment/indosat-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
            ...
            try {
                ...
                if (resp != null) {
                    ...
                    if (resp.getString(39).equals("00")) {
                        ...
                        screen.append(receiptTransaction.receiptHeader("Pembelian Pulsa Indosat"));

//                        screen.append("Pembelian Pulsa Indosat");
//                        screen.append("|");
//                        screen.append("|");
...
//                            screen.append("|");
                        ...
                        screen.append(receiptTransaction.receiptInfo("Voucher S/N", resp.getString(61).substring(43, 63)));
                        screen.append(receiptTransaction.noReceiptFooter());

//                        screen.append("Voucher S/N            : ");
//                        screen.append(resp.getString(61).substring(43, 63));
