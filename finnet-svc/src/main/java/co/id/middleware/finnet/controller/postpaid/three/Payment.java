            ...
            try {
                ...
                if (resp != null) {
                    ...
                    if (resp.getString(39).equals("00")) {
                        ...
                        screen.append(receiptTransaction.receiptHeader("Pembayaran Three"));
...
//                            screen.append("|");
                        ...
                        screen.append(receiptTransaction.receiptInfo("Nomor Handphone", "0" + Long.valueOf(resp.getString(61).substring(0, 20))));
                        screen.append(receiptTransaction.receiptInfo("Nama Pelanggan", redis_reserveData.substring(26, 76)));
