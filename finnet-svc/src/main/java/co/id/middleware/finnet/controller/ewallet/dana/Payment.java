package co.id.middleware.finnet.controller.ewallet.dana;
...
public class Payment {
    ...
    @RequestMapping(value = "/v1.0/payment/dana", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
...
//        String fee = env.getProperty("finnet.fee.dana");
...
//        String feeAccount = env.getProperty("finnet.ss.feeAccount");
        String validationProductCode = env.getProperty("finnet.productCode.dana");
            ...
            try {
                ...
                if (resp != null) {
                    ...
                    if (resp.getString(39).equals("00")) {
                        ...
                        screen.append(receiptTransaction.receiptHeader("Pembayaran Top Up Dana"));
