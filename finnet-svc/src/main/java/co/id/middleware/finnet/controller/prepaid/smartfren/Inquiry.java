...
@RestController
@Slf4j
@Component("InquiryPrepaidSmartfren")
public class Inquiry {
    ...
    @RequestMapping(value = "/v1.0/inquiry/smartfren-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
