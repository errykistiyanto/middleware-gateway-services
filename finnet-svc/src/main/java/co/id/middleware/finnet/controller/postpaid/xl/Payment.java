...
public class Payment {
    ...
    @RequestMapping(value = "/v1.0/payment/xl-postpaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
            ...
            try {
                ...
                if (resp != null) {
                    ...
                    if (resp.getString(39).equals("00")) {
                        screen.append(receiptTransaction.receiptHeader("Pembayaran XL"));

//                        screen.append("Pembayaran XL");
//                        screen.append("|");
//                        screen.append("|");
...
//                            screen.append("|");
                        ...
                        screen.append(receiptTransaction.receiptInfo("Nama Pelanggan", redis_reserveData.substring(48, 78)));
...
//                        screen.append(redis_reserveData.substring(48, 78));
//                        screen.append("|");
