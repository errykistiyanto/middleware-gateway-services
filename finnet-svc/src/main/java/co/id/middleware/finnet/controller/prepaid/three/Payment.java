package co.id.middleware.finnet.controller.prepaid.three;
...
public class Payment {
    ...
    @RequestMapping(value = "/v1.0/payment/three-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
...
//        String fee = env.getProperty("finnet.fee.three-prepaid");
...
//        String feeAccount = env.getProperty("finnet.ss.feeAccount");
        String validationProductCode = env.getProperty("finnet.productCode.three-prepaid");
            ...
            try {
                ...
                if (resp != null) {
                    ...
                    if (resp.getString(39).equals("00")) {
                        ...
                        screen.append(receiptTransaction.receiptHeader("Pembelian Pulsa Three"));

//                        screen.append("Pembelian Pulsa Three");
//                        screen.append("|");
//                        screen.append("|");
...
//                            screen.append("|");
                        ...
                        screen.append(receiptTransaction.receiptInfo("Nominal", "IDR " + df.format(Long.valueOf(resp.getString(61).substring(20, 32))).replace(",", ".")));
                        screen.append(receiptTransaction.receiptInfo("Harga", "IDR " + df.format(Long.valueOf(resp.getString(61).substring(20, 32))).replace(",", ".") + ",00"));

//                        screen.append("Nomor Handphone        : ");
//                        screen.append("0" + Long.valueOf(resp.getString(61).substring(0, 13)));
//                        screen.append("|");
//                        screen.append("Nominal                : ");
//                        screen.append("IDR " + df.format(Long.valueOf(resp.getString(61).substring(20, 32))).replace(",", "."));
//                        screen.append("|");
//                        screen.append("Harga                  : ");
//                        screen.append("IDR " + df.format(Long.valueOf(resp.getString(61).substring(20, 32))).replace(",", ".") + ",00");
//                        screen.append("|");
//
                        if (!channelCode.equals("6015")) { //!channelCode Open API
                            screen.append(receiptTransaction.receiptInfo("Biaya Administrasi", "IDR " + df.format(Long.valueOf(fee)).replace(",", ".") + ",00"));
                            screen.append(receiptTransaction.receiptInfo("Total Bayar", "IDR " + df.format(Long.valueOf(resp.getString(61).substring(20, 32)) + Long.valueOf(fee)).replace(",", ".") + ",00"));

//                            screen.append("Biaya Administrasi  : ");
//                            screen.append("IDR " + df.format(Long.valueOf(fee)).replace(",", ".") + ",00");
//                            screen.append("|");
//                            screen.append("Total Bayar         : ");
//                            screen.append("IDR " + df.format(Long.valueOf(resp.getString(61).substring(20, 32)) + Long.valueOf(fee)).replace(",", ".") + ",00");
                        }
//
                        screen.append(receiptTransaction.receiptInfo("Voucher S/N", resp.getString(61).substring(32, 52)));
                        screen.append(receiptTransaction.noReceiptFooter());

//                        screen.append("Voucher S/N             : ");
//                        screen.append(resp.getString(61).substring(32, 52));
