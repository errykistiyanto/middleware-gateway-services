package co.id.middleware.finnet.controller.prepaid.smartfren;
...
@RestController
@Slf4j
@Component("PaymentPrepaidSmartfren")
public class Payment {
    ...
    @RequestMapping(value = "/v1.0/payment/smartfren-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
...
//        String fee = env.getProperty("finnet.fee.smartfren-prepaid");
...
//        String feeAccount = env.getProperty("finnet.ss.feeAccount");
        String validationProductCode = env.getProperty("finnet.productCode.smartfren-prepaid");
            ...
            try {
                ...
                if (resp != null) {
                    ...
                    if (resp.getString(39).equals("00")) {
                        ...
                        screen.append(receiptTransaction.receiptHeader("Pembelian Pulsa Smartfren"));

//                        screen.append("Pembelian Pulsa Smartfren");
//                        screen.append("|");
//                        screen.append("|");
