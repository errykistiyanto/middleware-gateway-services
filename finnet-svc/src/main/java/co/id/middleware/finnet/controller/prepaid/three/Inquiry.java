...
public class Inquiry {
    ...
    @RequestMapping(value = "/v1.0/inquiry/three-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
    public ResponseEntity<String> Multibiller(@Valid @RequestBody InquiryRequest inquiryRequest,
        ...
        try {
            ...
            switch (Integer.parseInt(amount)) {
                ...
                case 500000:
                    screen.append(receiptTransaction.receiptHeader("Three Prepaid"));
