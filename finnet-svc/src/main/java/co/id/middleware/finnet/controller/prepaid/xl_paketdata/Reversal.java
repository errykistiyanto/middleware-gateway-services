...
@RestController
@Slf4j
@Component("ReversalPrepaidXLPaketData")
public class Reversal {
    ...
    @RequestMapping(value = "/v1.0/reversal/xl_paketdata-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
