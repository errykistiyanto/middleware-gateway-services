...
@RestController
@Slf4j
@Component("ReversalPrepaidIndosat")
public class Reversal {
    ...
    @RequestMapping(value = "/v1.0/reversal/indosat-prepaid", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
